...
export default function Hero() {
  const words = [
    ...
    "React.js & MERN Enthusiast",
    "Machine Learning Specialist",
    "Problem Solver | DSA 350+",
  ];
...
const profile = {
  name: 'Prakhar Agrawal',
    ...
    skills: [
        ...
        'MySQL', 'MongoDB', 'Docker', 'Machine Learning', 'TypeScript',
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-6 sm:mb-8">
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight">
                  <SparklesText text="Hello" fallbackText="Hi" />
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Building robust web apps ⚛️ | ML Specialist 🤖 | 350+ DSA
                  problems solved 🧠 | Turning ideas into reality 💡
                </p>
              </div>
